...
\noindent This document reproduces the Main Specification subsection and the Unemployment and Wage result subsections of my undergraduate honor thesis.  Section numbering is preserved from the thesis; the sections that precede (Introduction, Background, Toy Model, Data) and follow (Heterogeneity in Experience and Education, Limitations, Conclusion) are omitted here.  The empirical analysis links the occupation-level AI exposure score $\beta_o$ of \textcite{eloundou2024gpts} to the 2018--2025 Current Population Survey Annual Social and Economic Supplement (CPS-ASEC) accessed through IPUMS.
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.7\textwidth]{unemployment_stateYFE_plot.pdf}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.7\textwidth]{logwage_stateYFE_plot.pdf}
