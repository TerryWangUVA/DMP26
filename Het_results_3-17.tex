...
\subsection*{Change in unemployment, 2023--2025}
\begin{enumerate}\setcounter{enumi}{26}
  \item \hyperref[fig:delta_col]{$\Delta$ Unemployment 2023--2025 vs.\ AI exposure --- college}
  \item \hyperref[fig:delta_noncol]{$\Delta$ Unemployment 2023--2025 vs.\ AI exposure --- non-college}
\end{enumerate}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.88\textwidth]{delta_unemp_2023-2025_col.pdf}
\caption{Change in unemployment rate (2025 minus 2023) vs.\ AI exposure score, by major occupation group --- college subsample. Each point is one of the 22 BLS major occupation groups; the line is an OLS fit.}
\label{fig:delta_col}
\end{center}
\smallskip
\noindent\footnotesize\textit{Notes:} College subsample (educ $>$ 110). Occupation-group unemployment rates computed as simple means within the subsample. AI exposure is the group-mean Eloundou et al.\ (2024) GPT-4 beta score.
\end{figure}

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.88\textwidth]{delta_unemp_2023-2025_noncol.pdf}
\caption{Change in unemployment rate (2025 minus 2023) vs.\ AI exposure score, by major occupation group --- non-college subsample. Each point is one of the 22 BLS major occupation groups; the line is an OLS fit.}
\label{fig:delta_noncol}
\end{center}
\smallskip
\noindent\footnotesize\textit{Notes:} Non-college subsample (educ $\leq$ 110). Occupation-group unemployment rates computed as simple means within the subsample. AI exposure is the group-mean Eloundou et al.\ (2024) GPT-4 beta score.
\end{figure}
