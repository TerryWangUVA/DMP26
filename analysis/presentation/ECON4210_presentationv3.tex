...
\bigskip
\centering
\includegraphics[width=0.72\linewidth]{fig_postai.png}
...
\column{0.50\textwidth}
  ...
  \begin{itemize}
    ...
    \item Outcomes:
    \begin{itemize}
      \item Unemployment indicator (mean 3.4\%)
      \item Log real annual wages (CPI-deflated)
    \end{itemize}
  \end{itemize}
...
\column{0.48\textwidth}
  ...
  \begin{itemize}
    ...
    \item 0 (low: construction) to 0.78 (high: legal, CS)
    \item Time-invariant, assigned at occ.\ level
    \item Coefficients: per 0.1 increase in $\beta_o$
  \end{itemize}
\end{columns}
...
\column{0.54\textwidth}
  ...
  {\small\color{mygray}
    ...
    Four specs: (1) none $\rightarrow$ (2) sex $\rightarrow$
...
\column{0.43\textwidth}
  ...
  \begin{itemize}
    ...
    \medskip
    \item Pre-2022 $\hat\beta_t \approx 0$: parallel trends
    \item Post-2022 $\hat\beta_t$ diverges: AI effect
    \medskip
