...
\column{0.42\textwidth}
  \centering
  \includegraphics[width=0.95\linewidth]{starting_page.png}
\end{columns}
\end{frame}
...
\begin{itemize}
  ...
  \medskip
  \item \textcolor{red}{Output price $P_Y$ fixed (\textit{to make my life a little bit easier})}
\end{itemize}
...
\column{0.52\textwidth}
  \centering
  \includegraphics[width=0.95\linewidth]{empirical.png}
\column{0.45\textwidth}
  \Large
  The model predicts high-exposure workers should see worse outcomes post-2022.

  \bigskip
  \large\textbf{Let's test it.}
\end{columns}
\end{frame}
...
\column{0.35\textwidth}
  ...
  \begin{itemize}
    ...
    \item But the finding is not as robust as unemployment --- in other specs, not statistically significant
  \end{itemize}
\end{columns}
