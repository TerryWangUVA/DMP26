...
\begin{itemize}
  ...
  \item Ottaviano, Peri \& Wright (2013): different workers, different cutoffs. \textit{a slightly ``friendlier'' paper to read than GRH (2008)}
\end{itemize}
...
\begin{itemize}
  ...
  \medskip
  \item \textcolor{red}{Output price $P_Y$ fixed (\textit{to make my life a bit easier})}
\end{itemize}
...
\column{0.43\textwidth}
  ...
  \begin{itemize}
    ...
    \item \textbf{AI exposure:} Eloundou et al.\ (2024), occ-level LLM exposure score
    \item \textbf{Strategy:} ``DiD''
...
\column{0.35\textwidth}
  \small
  \begin{itemize}
    \item {\textit{Interesting}} pre-trends
    \medskip
    \item \textbf{Post-2022:} wages compress for high-exposure workers
    \item But the finding is not as robust as unemployment --- in other specs, result's not statistically significant
  \end{itemize}
\end{columns}
